	...
	Next
		...
		If _nQuantid > _nEstoque
			If M->C5_XTTPPED == 'S' // PM
				MsgBox("A quantidade informada ้ maior que o estoque disponํvel."+Chr(13)+Chr(10)+Chr(13)+Chr(10)+"Impossํvel incluir este produto com esta quantidade"+Chr(13)+Chr(10)+;
				       Chr(13)+Chr(10)+"Estoque disponํvel: "+Transform(_nEstoque,"@RE 999,999.99"),"Estoque Disponํvel","ALERT")
				lRet := .F.                        
			Else
				MsgBox("A quantidade informada ้ maior que o estoque disponํvel."+Chr(13)+Chr(10)+;
				       Chr(13)+Chr(10)+"Estoque disponํvel: "+Transform(_nEstoque,"@RE 999,999.99"),"Estoque Disponํvel","ALERT")
				lRet := .T.
			EndIf
		EndIf
