...
Local _oDlg
Local oFolder
Local oButDemP,oButDemM,oButDemI,oButDemE
...
Private oOk     := ""
Private oNo	    := ""
Private aSize   := {0,15,385,167,780,365}
Private _aCpoDEM:= {}
Private _aCpoPRO:= {}
Private cArqTMP := ""
Private cArqTRB := ""
...
// **************** I N T E R F A C E
Define MsDialog _oDlg Title " Rotinas de MRP " From C(aSize[1]),C(aSize[1]) TO C(aSize[6]),C(aSize[5]) Pixel

oFolder:= TFolder():New(C(aSize[2]), C(aSize[1]+3),aFolder,{},_oDlg,,,,.T.,.F.,C(aSize[3]),C(aSize[4]),)

// *********** Folder Demanda
@ C(aSize[1]+2), C(aSize[1]+2) TO C(aSize[1]+15),C(aSize[3]-3) LABEL "" Pixel Of oFolder:aDialogs[1]

@ C(aSize[1]+04),C(aSize[5]-095) BTNBMP oButDemM Resource "S4WB014B" SIZE C(028),C(030) Pixel Of oFolder:aDialogs[1] Message "Gerar Plano Mestre Prod."      Action( _aReaSZO := SZO->(GetArea()), U_A002MEST(), RestArea(_aReaSZO), U_A002PROD(), oMarkP:oBrowse:Refresh() )
@ C(aSize[1]+04),C(aSize[5]-070) BTNBMP oButDemI Resource "S4WB010N" SIZE C(030),C(030) Pixel Of oFolder:aDialogs[1] Message "Relat๓rio de Demanda"          Action( U_MPCPR001(1) )
@ C(aSize[1]+04),C(aSize[5]-045) BTNBMP oButDemE Resource "PMSEXCEL" SIZE C(030),C(030) Pixel Of oFolder:aDialogs[1] Message "Exporta Demanda para Excel  "  Action( U_MPCPR001(2) )

oMarkD 						:= MsSelect():New(	"TRB", "TRB_OK" , "" , _aCpoDEM , @lInverte, @cMarArea ,{ C(aSize[1]+18),C(aSize[1]+3),C(aSize[4]-13),C(aSize[3]-3) },,, oFolder:aDialogs[1])
...
// *********** Folder Producao
@ C(aSize[1]+2), C(aSize[1]+2) TO C(aSize[1]+15),C(aSize[3]-3) LABEL "" Pixel Of oFolder:aDialogs[2]

@ C(aSize[1]+04),C(aSize[5]-095) BTNBMP oButDemM Resource "PRODUTO"  SIZE C(030),C(030) Pixel Of oFolder:aDialogs[2] Message "Manuten็ใo Plano Mestre "     Action( _aReaSZO := SZO->(GetArea()), U_MPCPA001 (), RestArea(_aReaSZO), U_A002PROD(),  oMarkP:oBrowse:Refresh() )
@ C(aSize[1]+04),C(aSize[5]-070) BTNBMP oButDemI Resource "S4WB010N" SIZE C(030),C(030) Pixel Of oFolder:aDialogs[2] Message "Previsao de Produ็ใo"         Action( U_MPCPR003(1) )
//@ C(aSize[1]+04),C(aSize[5]-045) BTNBMP oButDemE Resource "PMSEXCEL" SIZE C(030),C(030) Pixel Of oFolder:aDialogs[2] Message "Exporta Previsใo para Excel"  Action( U_MPCPR003(2) )

oMarkP 						:= MsSelect():New(	"TMP", "TMP_OK" , "" , _aCpoPRO , @lInverte, @cMarArea ,{ C(aSize[1]+18),C(aSize[1]+3),C(aSize[4]-15),C(aSize[3]-5) },,, oFolder:aDialogs[2])
...
ฑฑบ                              M U L T  -  T  -  L O C K                                บฑฑ
ฑฑฬออออออออออออัอออออออออออัออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบPrograma    ณ P00DEDMA  ณ Seleciona itens e gera Temporario de demanda                 บฑฑ
ฑฑฬออออออออออออุอออออออออออฯอออออออออออออออออออออออออออออออออออออออออออัออออออัอออออออออออนฑฑ
ฑฑบAutor       ณ Actual Trend                                          ณ Data ณ  31/03/10 บฑฑ
ฑฑศออออออออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออฯออออออฯอออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
If Select("TRB") > 0
	...
	While TRB->(!Eof())
		IncProc("Ajustando valores")
		
		nMedia    := Round( (TRB->QUANT_CONS / round(nNumInd,0)), 0)
		nNecess   := Round( (TRB->SALDO + TRB->SALDO_OP + TRB->SALDO_SC + TRB->SALDO_PC)-(TRB->SALDO_PV + nMedia + TRB->EMP_SLD), 0)
		nNecessEmp:= Round( (TRB->SALDO)-(TRB->SALDO_PV+nMedia), 0)
	...
	For _n1 := 1 to Len(aStrTRB)
		...
		Else
			If AllTrim(aStrTRB[_n1,1]) == "SALDO"
				_cCampo := "B2_QATU"
