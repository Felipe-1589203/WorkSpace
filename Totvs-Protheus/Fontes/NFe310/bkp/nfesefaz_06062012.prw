			...
			If !Empty(SF2->F2_DUPL)	
				...
				#IFDEF TOP
					...
					BeginSql Alias cAliasSE1
						...
						((SE1.E1_TIPO = %Exp:MVNOTAFIS%) OR
						 ((SE1.E1_ORIGEM = 'LOJA701' OR SE1.E1_ORIGEM = 'FATA701') AND SE1.E1_TIPO IN (%Exp:cWhere%))) AND
						SE1.%NotDel%
						ORDER BY %Order:SE1%
					EndSql
				...
				While !Eof() .And. xFilial("SE1") == (cAliasSE1)->E1_FILIAL .And.;
					...
					SF2->F2_DOC == (cAliasSE1)->E1_NUM     
						If 	(cAliasSE1)->E1_TIPO = MVNOTAFIS .OR. (((cAliasSE1)->E1_ORIGEM = 'LOJA701' .OR. (cAliasSE1)->E1_ORIGEM = 'FATA701') .AND. (cAliasSE1)->E1_TIPO $ cWhere)					
							If cValLiqB == "1"
...
//						If MsSeek(xFilial("SD2")+(cAliasSD2)->D2_NFORI+(cAliasSD2)->D2_SERIORI+(cAliasSD2)->D2_CLIENTE+(cAliasSD2)->D2_LOJA+(cAliasSD2)->D2_COD+(cAliasSD2)->D2_ITEMORI)
	         ...
	         //   Else 
			 //		nDesconto := (cAliasSD2)->D2_DESCON            	dia 02/02/2012 - Removido desconto
	            EndIf
...
//					IIF(!(cAliasSD2)->D2_TIPO$"IP", IIf(!(cAliasSD2)->D2_TIPO $ "D", (cAliasSD2)->D2_PRCVEN+nDesconto+(NoRound((cAliasSD2)->D2_DESCZFR/(cAliasSD2)->D2_QUANT,2)), (cAliasSD2)->D2_PRCVEN), 0),;
				...
				aadd(aProd,	{Len(aProd)+1,;
					...
					SB1->B1_UM,;
					(cAliasSD2)->D2_QUANT,;
					IIF(!(cAliasSD2)->D2_TIPO$"IP",Iif(!(cAliasSD2)->D2_TIPO$"D",(cAliasSD2)->D2_TOTAL+(cAliasSD2)->D2_DESCZFR,(cAliasSD2)->D2_TOTAL),0),;
					...
					(cAliasSD2)->D2_SEGURO,;
					(nDesconto),;
					IIF(!(cAliasSD2)->D2_TIPO$"IP", IIf(!(cAliasSD2)->D2_TIPO $ "D", (cAliasSD2)->D2_PRCVEN+(NoRound((cAliasSD2)->D2_DESCZFR/(cAliasSD2)->D2_QUANT,2)), (cAliasSD2)->D2_PRCVEN), 0),;
...
//							aISS[01] += (cAliasSD2)->D2_TOTAL+(cAliasSD2)->D2_DESCON    // Linha original alterado em 02/02/2012 - Jean
							aISS[02] += CD2->CD2_BC
...
IF ExistBlock("PE01NFESEFAZ")                   
	...
	aParam := {aProd,cMensCli,cMensFis,aDest,aNota,aInfoItem,aDupl,aTransp,aEntrega,aRetirada,aVeiculo}
...
Endif
cString += '<vProd>' +ConvType(aProd[10],15,2)+'</vProd>'  // Alterado em 25/11/11 Jean Cavalcante - Incluido a soma dos descontos
