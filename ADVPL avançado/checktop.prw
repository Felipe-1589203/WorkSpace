...
//Endif
	...
	While !Eof()
		...
		dbCloseArea(cTabela)
		if empty(cUserTable)
			msgstop('Para dar continuidade neste processo; voce precisa reiniciar o servico do DBACCESS,; logo apos carregue este programa novamente.')
			Return
		Endif
		...
		While !Eof()
			...
			conout("atualizando tabela "+SX2->X2_ARQUIVO)
			dbSelectArea("SX2")
			dbSkip()
		End
		dbSelectArea("SM0")
	...
	msgstop("Processo concluido. ; Reinicialize o Servico do DBACCESS; As modificacoes foram registradas na tabela CHECKTOP.")
Return(.T.)
/*
ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
