...
±±ºPrograma  ³MTA265I   ºAutor  ³Alexandre Sousa     º Data ³  12/13/09   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³PE no final do enderecamento. Utilizado para liberar os     º±±
±±º          ³pedidos que estao amarrados automaticamente.                º±±
...
User Function MTA265I()
	...
	If !DbSeek(xFilial("SC2")+SDA->DA_DOC)
		Return
    EndIf
