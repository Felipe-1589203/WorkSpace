...
±±³ 28.08.07 ³Geraldo A. 	 ³Alteraçao nas informaçoes impressas         ³±±
...
TRCell():New(oBaixas,"E5_PREFIXO"	,, STR0049,,         ,         .F.)	//"Prf"
TRCell():New(oBaixas,"E5_NUMERO" 	,, STR0050,,         ,         .F.)	//"Numero"
//TRCell():New(oBaixas,"E5_PARCELA"	,, STR0051,,         ,         .F.)	//"Prc"
//TRCell():New(oBaixas,"E5_TIPODOC"	,, STR0052,,         ,         .F.)	//"TP"
//TRCell():New(oBaixas,"E5_CLIFOR"		,, STR0053,,         ,         .F.)	//"Cli/For"
TRCell():New(oBaixas,"NOME CLI/FOR"	,, STR0054,,       20,         .F.)	//"Nome Cli/For"
TRCell():New(oBaixas,"E5_NATUREZ"	,, STR0055,,        	,         .F.)	//"Natureza"
TRCell():New(oBaixas,"E5_VENCTO"		,, STR0056,,         ,         .F.)	//"Vencto"
TRCell():New(oBaixas,"E5_HISTOR"		,, STR0057,,        	,         .F.)	//"Historico"
//TRCell():New(oBaixas,"E5_DATA"		,, STR0058,,         ,         .F.)	//"Dt Baixa"
TRCell():New(oBaixas,"E5_VALOR"		,, STR0059,, TamSX3("E5_VALOR")[1]	,/*[lPixel]*/,,"RIGHT",,"RIGHT")	//"Valor Original"
...
TRCell():New(oBaixas,"E5_VALORPG"	,, STR0065,, TamSX3("E5_VALOR")[1]+4,/*[lPixel]*/,,"RIGHT",,"RIGHT")//"Total Baixado"
//TRCell():New(oBaixas,"E5_BANCO"		,, STR0066,,         ,         .F.)	//"Bco"
//TRCell():New(oBaixas,"E5_DTDIGIT"	,, STR0067,,         ,         .F.)	//"Dt Dig."
//TRCell():New(oBaixas,"E5_MOTBX"		,, STR0068,,         ,         .F.)	//"Mot"
//TRCell():New(oBaixas,"E5_ORIG"		,, STR0069,,         ,         .F.)	//"Orig"
			...
			While NEWSE5->(!EOF()) .and. &cCond2=cAnterior .and. NEWSE5->E5_FILIAL=xFilial("SE5") .and. lContinua
				...
				If (nDesc+nValor+nJurMul+nCM+nVlMovFin) > 0
					...
					Else
						...
						Else
							@li, 71 PSAY SubStr(ALLTRIM(cHistorico),1,21)
						EndIf
						//@li, 93 PSAY dBaixa
						IF nVlr > 0
							@li,103 PSAY nVlr Picture tm(nVlr,14,nDecs)
