...
If Mv_par01 == 1
	cQuery += CRLF + "  INNER JOIN "+ RetSQLName( 'SA6' ) +" SA6 "
Else
	cQuery += CRLF + "   LEFT JOIN "+ RetSQLName( 'SA6' ) +" SA6 "
EndIf
cQuery += CRLF + "     ON SA6.A6_FILIAL   = '"+ xFilial("SA6") +"'"
cQuery += CRLF + "    AND SA6.A6_COD      = SE1.E1_PORTADO"
cQuery += CRLF + "    AND SA6.A6_AGENCIA  = SE1.E1_AGEDEP"
cQuery += CRLF + "    AND SA6.A6_NUMCON   = SE1.E1_CONTA"
If Mv_par01 == 1
	cQuery += CRLF + "    AND SA6.A6_XFACTOR  = 'S'"
EndIf
cQuery += CRLF + "    AND SA6.D_E_L_E_T_  = ' '"

cQuery += CRLF + "   LEFT JOIN "+ RetSQLName( 'SEA' ) +" SEA "
cQuery += CRLF + "     ON SEA.EA_FILIAL   = SE1.E1_FILIAL"
cQuery += CRLF + "    AND SEA.EA_PREFIXO  = SE1.E1_PREFIXO"
cQuery += CRLF + "    AND SEA.EA_NUM      = SE1.E1_NUM"
cQuery += CRLF + "    AND SEA.EA_PARCELA  = SE1.E1_PARCELA"
cQuery += CRLF + "    AND SEA.EA_TIPO     = SE1.E1_TIPO"
cQuery += CRLF + "    AND SEA.EA_CART     = 'R'"
cQuery += CRLF + "    AND SEA.EA_PORTADO  = SE1.E1_PORTADO"
cQuery += CRLF + "    AND SEA.EA_AGEDEP   = SE1.E1_AGEDEP"
cQuery += CRLF + "    AND SEA.EA_NUMCON   = SE1.E1_CONTA"
cQuery += CRLF + "    AND SEA.D_E_L_E_T_  = ' '"
                                                            
cQuery += CRLF + "  WHERE SE1.E1_FILIAL   = '"+ xFilial("SE1") +"'"
If Mv_par02 == 1
	If Mv_par03 == 1     //  Boleto
		cQuery += CRLF + "    AND SE1.E1_XTPPAG = 'BOL'"
	ElseIf Mv_par03 == 2 //  Cheque
		cQuery += CRLF + "    AND SE1.E1_XTPPAG = 'CH '"
	ElseIf Mv_par03 == 3 //  Comissaria
		cQuery += CRLF + "    AND SE1.E1_XTPPAG = 'CO '"
	ElseIf Mv_par03 == 4 //  Credito Conta
		// cQuery += CRLF + "    AND SE1.E1_XTPPAG = 'CC '"
		cQuery += CRLF + "    AND (SE1.E1_XTPPAG = 'CC ' OR SE1.E1_XTPPAG = 'CR ') "
	ElseIf Mv_par03 == 5 //  Dinheiro
		cQuery += CRLF + "    AND SE1.E1_XTPPAG = 'R$ '"
	EndIf
EndIf
cQuery += CRLF + "    AND ((SE1.E1_NUMBOR  BETWEEN '"+ Mv_par04       +"' AND '"+ Mv_par05       +"'"
cQuery += CRLF + "    AND   SE1.E1_DATABOR BETWEEN '"+ Dtos(Mv_par06) +"' AND '"+ Dtos(Mv_par07) +"')"
cQuery += CRLF + "     OR  (SE1.E1_NUMBOR  = '"+ Space(Len(Mv_par04)) +" '"
cQuery += CRLF + "    AND   SE1.E1_DATABOR = '"+ Dtos(Ctod("")) +"')) "

cQuery += CRLF + "    AND SE1.E1_PORTADO BETWEEN '"+ Mv_par08       +"' AND '"+ Mv_par11       +"'"
cQuery += CRLF + "    AND SE1.E1_AGEDEP  BETWEEN '"+ Mv_par09       +"' AND '"+ Mv_par12       +"'"
cQuery += CRLF + "    AND SE1.E1_CONTA   BETWEEN '"+ Mv_par10       +"' AND '"+ Mv_par13       +"'"

cQuery += CRLF + "    AND SE1.E1_CLIENTE BETWEEN '"+ Mv_par14       +"' AND '"+ Mv_par16       +"'"
cQuery += CRLF + "    AND SE1.E1_LOJA    BETWEEN '"+ Mv_par15       +"' AND '"+ Mv_par17       +"'"

cQuery += CRLF + "    AND ((SE1.E1_EMISSAO BETWEEN '"+ Dtos(Mv_par18) +"' AND '"+ Dtos(Mv_par19) +"') OR (SE1.E1_EMIS1 BETWEEN '"+ Dtos(Mv_par18) +"' AND '"+ Dtos(Mv_par19) +"'))"
cQuery += CRLF + "    AND SE1.E1_VENCREA BETWEEN '"+ Dtos(Mv_par20) +"' AND '"+ Dtos(Mv_par21) +"'"
cQuery += CRLF + "    AND ((SE1.E1_SALDO > 0 ) OR (SE1.E1_SALDO = 0 AND SE1.E1_BAIXA  = '"+ Dtos(Ctod("")) +"') )"

cQuery += CRLF + "    AND SE1.E1_PREFIXO BETWEEN '"+ Mv_par22       +"' AND '"+ Mv_par23       +"'"
cQuery += CRLF + "    AND SE1.E1_NUM     BETWEEN '"+ Mv_par24       +"' AND '"+ Mv_par25       +"'"
cQuery += CRLF + "    AND SE1.E1_PARCELA BETWEEN '"+ Mv_par26       +"' AND '"+ Mv_par27       +"'"
cQuery += CRLF + "    AND SE1.E1_TIPO    BETWEEN '"+ Mv_par28       +"' AND '"+ Mv_par29       +"'"

If Mv_par30 == 2 // Imprime titulos em desconto
	cQuery += CRLF + "    AND SE1.E1_SITUACA NOT IN ('2','7')"
EndIf

If Mv_par31 == 2 // Imprime titulos provisorios
	cQuery += CRLF + "    AND SE1.E1_TIPO    NOT IN "+ FormatIn(MVPROVIS,"/")
EndIf

If Mv_par32 == 2 // Imprime titulos de adiantamento
	cQuery += CRLF + "    AND SE1.E1_TIPO    NOT IN "+ FormatIn(MVRECANT+"/"+MV_CRNEG,"/")
EndIf

If Mv_par33 == 2 // Imprime titulos de abatimento
	cQuery += CRLF + "    AND SE1.E1_TIPO    NOT IN "+ FormatIn(MVABATIM,"/")
EndIf
...
If nOrdem == 1        // Tipo de Recebimento
	cQuery += CRLF + " ORDER BY SE1.E1_XTPPAG, SE1.E1_PORTADO, SE1.E1_AGEDEP, SE1.E1_CONTA, SE1.E1_CLIENTE, SE1.E1_LOJA, SE1.E1_PREFIXO, SE1.E1_NUM, SE1.E1_PARCELA"
	titulo += CRLF + " por Tipo de Recebimento"
	
ElseIf nOrdem == 2    // Banco/Agencia/Conta
	cQuery += CRLF + " ORDER BY SE1.E1_PORTADO, SE1.E1_AGEDEP, SE1.E1_CONTA, SE1.E1_XTPPAG, SE1.E1_CLIENTE, SE1.E1_LOJA, SE1.E1_PREFIXO, SE1.E1_NUM, SE1.E1_PARCELA"
	titulo += CRLF + " Por Banco/Agencia/Conta"
	
ElseIf nOrdem == 3    // Border๔
	cQuery += CRLF + " ORDER BY SE1.E1_NUMBOR, SE1.E1_CLIENTE, SE1.E1_LOJA, SE1.E1_PREFIXO, SE1.E1_NUM, SE1.E1_PARCELA"
	titulo += CRLF + " por N๚mero de Border๔"
	
ElseIf nOrdem == 4    // Cliente + Loja
	cQuery += CRLF + " ORDER BY SE1.E1_CLIENTE, SE1.E1_LOJA, SE1.E1_PREFIXO, SE1.E1_NUM, SE1.E1_PARCELA"
	titulo += CRLF + " por Cliente + Loja"
	
ElseIf nOrdem == 5    // Prefixo + Titulo
	cQuery += CRLF + " ORDER BY SE1.E1_PREFIXO, SE1.E1_NUM, SE1.E1_PARCELA, SE1.E1_CLIENTE, SE1.E1_LOJA"
	titulo += CRLF + " por Prefixo + Titulo"
	
ElseIf nOrdem == 6    // Data Vencto + Banco/Agencia/Conta
	cQuery += CRLF + " ORDER BY Dtos(SE1.E1_VENCREA)+SE1.E1_PORTADO, SE1.E1_AGEDEP, SE1.E1_CONTA, SE1.E1_XTPPAG, SE1.E1_CLIENTE, SE1.E1_LOJA, SE1.E1_PREFIXO, SE1.E1_NUM, SE1.E1_PARCELA"
	titulo += CRLF + " Por  Data Vencto + Banco/Agencia/Conta"
	
ElseIf nOrdem == 7    // Data Emiss]ao + Banco/Agencia/Conta
	cQuery += CRLF + " ORDER BY Dtos(SE1.E1_EMISSAO)+SE1.E1_PORTADO, SE1.E1_AGEDEP, SE1.E1_CONTA, SE1.E1_XTPPAG, SE1.E1_CLIENTE, SE1.E1_LOJA, SE1.E1_PREFIXO, SE1.E1_NUM, SE1.E1_PARCELA"
	titulo += CRLF + " Por  Data Vencto + Banco/Agencia/Conta"
	
ElseIf nOrdem == 8    // Data Vencto + Cliente/Loja
	cQuery += CRLF + " ORDER BY Dtos(SE1.E1_VENCREA) + SE1.E1_CLIENTE, SE1.E1_LOJA, SE1.E1_PREFIXO, SE1.E1_NUM, SE1.E1_PARCELA"
	titulo += CRLF + " Por  Data Vencto + Banco/Agencia/Conta"
	
ElseIf nOrdem == 9    // Data Emiss]ao + Cliente/Loja
	cQuery += CRLF + " ORDER BY Dtos(SE1.E1_EMISSAO) + SE1.E1_CLIENTE, SE1.E1_LOJA, SE1.E1_PREFIXO, SE1.E1_NUM, SE1.E1_PARCELA"
	titulo += CRLF + " Por  Data Vencto + Banco/Agencia/Conta"
EndIf         

MemoWrite("MFINR003.txt",cQuery)
