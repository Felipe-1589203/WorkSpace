...
nPosH    := nPosHOld + 360
nAuxV := nPosVOld
oDanfe:Say(nAuxV,nPosHOld-80,"DANFE",oFont18N:oFont)
nAuxV += Char2PixV(oDanfe,"X",oFont18N) + (SAYVSPACE*3)
nAuxH := nPosHOld
oDanfe:Say(nAuxV,nAuxH-80,"DOCUMENTO AUXILIAR DA",oFont07:oFont)                   
nAuxV += Char2PixV(oDanfe,"X",oFont08) + SAYVSPACE
oDanfe:Say(nAuxV,nAuxH-80,"NOTA FISCAL ELETRÔNICA",oFont07:oFont)
nAuxV += Char2PixV(oDanfe,"X",oFont08) + SAYVSPACE
oDanfe:Say(nAuxV+10,nAuxH-80,"0-ENTRADA",oFont08:oFont)
oDanfe:Say(nAuxV+40,nAuxH-80,"1-SAÍDA"  ,oFont08:oFont)
oDanfe:Box(nAuxV+10,nAuxH+150,nAuxV+50,nAuxH+210)
oDanfe:Say(nAuxV+15,nAuxH+160,oIdent:_TpNf:Text,oFont08:oFont)
nAuxV += 10
//oDanfe:Say(nAuxV,nAuxH,IIf(oIdent:_TpNf:Text=="1","SAÍDA","ENTRADA"),oFont18N:oFont)
nAuxV += Char2PixV(oDanfe,"X",oFont18N) + (SAYVSPACE*3)
oDanfe:Say(nAuxV,nAuxH-80,"N. "+StrZero(Val(oIdent:_NNf:Text),9),oFont10N:oFont)
nAuxV += Char2PixV(oDanfe,"X",oFont11) + SAYVSPACE
oDanfe:Say(nAuxV,nAuxH-80,"SÉRIE "+oIdent:_Serie:Text,oFont10N:oFont)
nAuxV += Char2PixV(oDanfe,"X",oFont11) + SAYVSPACE
oDanfe:Say(nAuxV,nAuxH-80,"FOLHA "+StrZero(nFolha,2)+"/"+StrZero(nFolhas,2),oFont10N:oFont)
nAuxV += Char2PixV(oDanfe,"X",oFont11) + SAYVSPACE
nPosHOld := nPosH+HSPACE
nPosH    := nHPage
oFont8N   := TFontEx():New(oDanfe,"Times New Roman",07,07,.T.,.T.,.F.)// 5
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
If nFolha == 1
	oDanfe:Box(260,1378,nPosV,nPosH)                                                       
	oDanfe:Box(260,1028,nPosV,nPosH) 
	oDanfe:Box(510,1378,nPosV,nPosH) 
	oDanfe:Box(420,1378,nPosV,nPosH) 
	oDanfe:Box(520,1378,nPosV,nPosH) 
	...
	oDanfe:Say(430,1393,"CHAVE DE ACESSO DA NF-E",oFont07N:oFont)	
	oDanfe:Say(450,1393,TransForm(SubStr(oNF:_InfNfe:_ID:Text,4),"@r 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999"),oFont10N:oFont)		
Else
	oDanfe:Box(030,1378,nPosV,nPosH) 
	oDanfe:Box(030,1028,nPosV,nPosH) 
	oDanfe:Box(260,1378,nPosV,nPosH)                                                                                                  
	oDanfe:Box(180,1378,nPosV,nPosH)
	oDanfe:Box(270,1378,nPosV,nPosH) 	                                             
	...
	oDanfe:Say(200,1393,"CHAVE DE ACESSO DA NF-E",oFont07N:oFont)	
	oDanfe:Say(225,1393,TransForm(SubStr(oNF:_InfNfe:_ID:Text,4),"@r 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999"),oFont10N:oFont)	
EndIf
...
Else
	If nFolha == 1
		oDanfe:Say(560,1393,"Consulta de autenticidade no portal nacional da NF-e",oFont10:oFont)	
		oDanfe:Say(590,1393,"www.nfe.fazenda.gov.br/portal ou no site da SEFAZ Autorizada",oFont10:oFont)		
	Else
		oDanfe:Say(300,1413,"Consulta de autenticidade no portal nacional da NF-e",oFont10:oFont)	
		oDanfe:Say(330,1413,"www.nfe.fazenda.gov.br/portal ou no site da SEFAZ Autorizada",oFont10:oFont)			
	EndIf
EndIf
