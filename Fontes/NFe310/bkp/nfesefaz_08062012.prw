	...
	If MsSeek(xFilial("SF1")+cNota+cSerie+cClieFor+cLoja)
		...
		Else				
			...
			While !Eof() .And. xFilial("SD1") == (cAliasSD1)->D1_FILIAL .And.;
				...
				//Condicao trazida apos compatibilizacao dos fontes na atualizacao de build [Bruno Parreira, Actual Trend, 28/05/2012]
...
//Condicao abaixo trazida da compatibilizacao dos fontes na atualizacao de build [Bruno Parreira, Actual Trend, 28/05/2012]
If Len(cMsgFis)>0    
	cString += '<Fisco>'+ConvType(cMsgFis,Len(cMsgFis))+'</Fisco>'
EndIf                                                                                                                      
//Fim Bloco
