...
c_Query += "                 SC5.C5_CLIENTE, SC5.C5_LOJACLI, SC5.C5_LOJAENT, SA1.A1_NOME, SA1.A1_END, SA1.A1_BAIRRO, SA1.A1_MUN, SA1.A1_EST, SA1.A1_CEP, SC5.C5_TRANSP," + c_EOL
...
While (cAliasA)->(!Eof())
	...
	If nLin > 57
		...
		If (cAliasA)->C5_TIPO $ 'B/D'
			...
			c_end		:=  Alltrim(SA2->A2_END)+", "+SA2->A2_NR_END
		...
		Else
			...
			c_end		:=  Alltrim(SA1->A1_END)+", "+SA1->A1_XNUM
