...
//FWExecView( /*cTitulo*/, /*cFonteModel*/, /*nAcao*/, /*bOk*/ )
	...
	If lOk
		Help( ,, 'Help',, 'Foi alterada a segunda Uidade de medida', 1, 0,,,,,,{"Reconfira"})
	Else
		Help(,1,"Help","Processamento","Foi cancelada a alteracao da segunda Unidade de Medida",1,0,,,,,,{"Refaça o Teste"})
	EndIf
