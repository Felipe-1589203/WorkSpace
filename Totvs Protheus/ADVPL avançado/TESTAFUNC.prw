...
/*/	_aGrpUSR := UsrRetGrp()
	...
	If !_lDESENV
		MsgStop("Usuario nao autorizado, solicite acesso ao Administrador", "Operacao nao permitida")
		RETURN
	ENDIF
/*/
	//Criando a janela
...
Static Function fExecuta()
    ...
    If ! Empty(cFormula)
        ...
        If ! Empty(cError)
            MsgStop("Houve um erro na Formula digitada: "+CRLF+CRLF+cError, "Aten��o")
        else
