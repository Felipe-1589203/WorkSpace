...
// XXXXXXXXXXXXXXXXXXX 999,999.99  999,999.99  999,999.99  999,999.99  999,999.99  999,999.99  999,999.99  999,999.99  999,999.99  999,999.99  999,999.99  999,999.99  999,999.99  999,999.99  999,999.99  999,999.99   "
...
While !Eof() .And. !lEnd 
  ...
  IncRegua()
   ...
   DbSelectArea("TRB")
	  ...
	  EndCase
      @ Li, aCol[02] PSAY Transform(TRB->D01, "@E 999,999.99")
      @ Li, aCol[03] PSAY Transform(TRB->D02, "@E 999,999.99")
      @ Li, aCol[04] PSAY Transform(TRB->D03, "@E 999,999.99")
      @ Li, aCol[05] PSAY Transform(TRB->D04, "@E 999,999.99")
      @ Li, aCol[06] PSAY Transform(TRB->D05, "@E 999,999.99")
      @ Li, aCol[07] PSAY Transform(TRB->D06, "@E 999,999.99")
      @ Li, aCol[08] PSAY Transform(TRB->D07, "@E 999,999.99")
      @ Li, aCol[09] PSAY Transform(TRB->D08, "@E 999,999.99")
      @ Li, aCol[10] PSAY Transform(TRB->D09, "@E 999,999.99")
      @ Li, aCol[11] PSAY Transform(TRB->D10, "@E 999,999.99")
      @ Li, aCol[12] PSAY Transform(TRB->D11, "@E 999,999.99")
      @ Li, aCol[13] PSAY Transform(TRB->D12, "@E 999,999.99")
      @ Li, aCol[14] PSAY Transform(TRB->D13, "@E 999,999.99")
      @ Li, aCol[15] PSAY Transform(TRB->D14, "@E 999,999.99")
      @ Li, aCol[16] PSAY Transform(TRB->D15, "@E 999,999.99")
      @ Li, aCol[17] PSAY Transform(TRB->D16, "@E 999,999.99")
	  Li++
 ...
 Enddo  
   ...
   @ Li, aCol[02] PSAY Transform(ndia01, "@E 999,999.99")
   @ Li, aCol[03] PSAY Transform(ndia02, "@E 999,999.99")
   @ Li, aCol[04] PSAY Transform(ndia03, "@E 999,999.99")
   @ Li, aCol[05] PSAY Transform(ndia04, "@E 999,999.99")
   @ Li, aCol[06] PSAY Transform(ndia05, "@E 999,999.99")
   @ Li, aCol[07] PSAY Transform(ndia06, "@E 999,999.99")
   @ Li, aCol[08] PSAY Transform(ndia07, "@E 999,999.99")
   @ Li, aCol[09] PSAY Transform(ndia08, "@E 999,999.99")
   @ Li, aCol[10] PSAY Transform(ndia09, "@E 999,999.99")
   @ Li, aCol[11] PSAY Transform(ndia10, "@E 999,999.99")
   @ Li, aCol[12] PSAY Transform(ndia11, "@E 999,999.99")
   @ Li, aCol[13] PSAY Transform(ndia12, "@E 999,999.99")
   @ Li, aCol[14] PSAY Transform(ndia13, "@E 999,999.99")                                                      
   @ Li, aCol[15] PSAY Transform(ndia14, "@E 999,999.99")                                                      
   @ Li, aCol[16] PSAY Transform(ndia15, "@E 999,999.99")                                                      
   @ Li, aCol[17] PSAY Transform(ndia16, "@E 999,999.99")                                                      
 ...
 LI++
  ...
  DbSelectArea("TRD")
   ...
   DbSelectArea("TRD")
      ...
      @ Li, aCol[02] PSAY Transform(TRD->D17, "@E 999,999.99")
      @ Li, aCol[03] PSAY Transform(TRD->D18, "@E 999,999.99")
      @ Li, aCol[04] PSAY Transform(TRD->D19, "@E 999,999.99")
      @ Li, aCol[05] PSAY Transform(TRD->D20, "@E 999,999.99")
      @ Li, aCol[06] PSAY Transform(TRD->D21, "@E 999,999.99")
      @ Li, aCol[07] PSAY Transform(TRD->D22, "@E 999,999.99")
      @ Li, aCol[08] PSAY Transform(TRD->D23, "@E 999,999.99")
      @ Li, aCol[09] PSAY Transform(TRD->D24, "@E 999,999.99")
      @ Li, aCol[10] PSAY Transform(TRD->D25, "@E 999,999.99")
      @ Li, aCol[11] PSAY Transform(TRD->D26, "@E 999,999.99")
      @ Li, aCol[12] PSAY Transform(TRD->D27, "@E 999,999.99")
      @ Li, aCol[13] PSAY Transform(TRD->D28, "@E 999,999.99")
      @ Li, aCol[14] PSAY Transform(TRD->D29, "@E 999,999.99")
      @ Li, aCol[15] PSAY Transform(TRD->D30, "@E 999,999.99")
      @ Li, aCol[16] PSAY Transform(TRD->D31, "@E 999,999.99")
	  Li++
	  ndia17 += TRD->D17
	  ndia18 += TRD->D18
	  ndia19 += TRD->D19
...
/*
  ...
  */      
   ...
   @ Li, aCol[02] PSAY Transform(ndia17, "@E 999,999.99")
   @ Li, aCol[03] PSAY Transform(ndia18, "@E 999,999.99")
   @ Li, aCol[04] PSAY Transform(ndia19, "@E 999,999.99")
   @ Li, aCol[05] PSAY Transform(ndia20, "@E 999,999.99")
   @ Li, aCol[06] PSAY Transform(ndia21, "@E 999,999.99")
   @ Li, aCol[07] PSAY Transform(ndia22, "@E 999,999.99")
   @ Li, aCol[08] PSAY Transform(ndia23, "@E 999,999.99")
   @ Li, aCol[09] PSAY Transform(ndia24, "@E 999,999.99")
   @ Li, aCol[10] PSAY Transform(ndia25, "@E 999,999.99")
   @ Li, aCol[11] PSAY Transform(ndia26, "@E 999,999.99")
   @ Li, aCol[12] PSAY Transform(ndia27, "@E 999,999.99")
   @ Li, aCol[13] PSAY Transform(ndia28, "@E 999,999.99")
   @ Li, aCol[14] PSAY Transform(ndia29, "@E 999,999.99")                                                      
   @ Li, aCol[15] PSAY Transform(ndia30, "@E 999,999.99")                                                      
   @ Li, aCol[16] PSAY Transform(ndia31, "@E 999,999.99")                                                      
...
aAdd(aRegs,{cPerg,"13","Segmento         ? ","","","MV_CHD","C",01,0,0,"C","","MV_PAR13","Automotivo","","","","","Corporativo","","","","","Varejo","","","","","MultLockCenter","","","","","","","","",""})
